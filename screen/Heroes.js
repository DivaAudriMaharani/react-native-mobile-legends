  ...
  render(){
    return(
      <View style={nbStyles.subtitle}>
          <Text style={{fontSize: 25, marginTop:20,  marginBottom: 10, textAlign: 'center', color: 'white', fontWeight : 'bold'}}>
            Heroes 
          </Text>

          <Image
           style={{alignItems: 'center', width: 370, height:160, marginBottom: 25, marginTop:10, }}
          ...
          <Image
           style={{alignItems: 'center', width: 370, height:160, marginBottom: 80, marginTop:10, }}
